                ...
                <div className={styles.list}>
                    <div className={inter.className}>
                        <div className={styles.description}>
                            ...
                            <p onClick={handleChangeilab}>Research Assistant <span className={styles.arrowright}>-&gt;</span></p>
                            <p onClick={handleChangeGuard}>Lifeguard/Swim Instructor <span className={styles.arrowright}>-&gt;</span></p>
                        </div>
                    </div>
                   <div>
    <Box sx={{ height: 180 }}>
